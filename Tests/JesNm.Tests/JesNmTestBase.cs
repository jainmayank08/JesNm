...
namespace JesNm.Tests
{
    public abstract class JesNmTestBase : AbpIntegratedTestBase
    {
        protected JesNmTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<JesNmApplicationModule>();
            modules.Add<JesNmDataModule>();
        }

        public void UsingDbContext(Action<JesNmDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<JesNmDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<JesNmDbContext, T> func)
        {
            T result;
